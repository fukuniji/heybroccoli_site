      ...
      <div class="approach__content content-aproach">
        <div class="content-aproach__col-1 col-1">
          ...
          <div class="col-1__text-3">
            <span col-1__text-3_color>Привычки круче диет:</span> вы увидите,
  ...
  <div class="services">
    <div class="container">
      ...
      <div class="services__cards card">
        ...
        <div class="card__text">
            Формат работы: раз в неделю созвон на 30-45 минут, обсуждаем
      ...
      <div class="services__cards card">
        ...
        <div class="card__text">
          Формат работы: заполнение анкеты и часовая консультация для
